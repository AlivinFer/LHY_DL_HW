...
from Week2.gradient_descent import *
from Week2.plotData import *
...
print('For population = 35,000, we predict a profit of {:0.3f} (This value should be about 4519.77)'
      .format(predict1 * 10000))
predict2 = np.dot(np.array([1, 7]), theta)
print('For population = 70,000, we predict a profit of {:0.3f} (This value should be about 45342.45)'
...
# 在 start 和 stop 之间产生 num 个线性向量，每个向量之间等距
theta0_vals = np.linspace(-10, 10, 100)
theta1_vals = np.linspace(-1, 4, 100)

# np.meshgrid() 生成网格点坐标矩阵(把两个数组的笛卡尔积内的元素的第一二个坐标分别放入两个矩阵中)
